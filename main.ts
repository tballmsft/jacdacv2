...
class microbitAccelerometer extends jacdac.SensorClient {
    constructor(requiredDevice: string = null) {
        super("accelerometer", jacdac.SRV_ACCELEROMETER, requiredDevice);
    }
 ...
 */
const accell = new microbitAccelerometer();